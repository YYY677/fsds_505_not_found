...
london.plot(edgecolor=(0.8, 0, 0, 0.5), facecolor='none', 
...
london['point_density'] = london['point_count'] / london_wards['HECTARES']
...
# 更新标题以反映点密度
ax.set_title('Density of Points in London Boroughs', fontsize=16)
plt.show()
```
...
for i, room_type in enumerate(room_types):
    ...
    subset.plot(ax=ax1, color=colors[i], marker='o', markersize=1, 
