...
# Define softer and aesthetically pleasing cluster colors (without green)
cluster_colors = {
    0: '#F6A8B2',  # Soft pink
    1: '#F7D2A1',  # Warm peach
    2: '#B3CDE0',  # Soft light blue
    3: '#F2C9E3'   # Light lavender
}
...
ax.set_title("K-Means Clustering Results by LSOA", fontsize=16)
