...
```{python}
from shapely.geometry import Point
# Step 2: Filter out only the columns we need
...
# Step 3: Convert longitude and latitude to geometry (Point)
...
# Step 5: Optionally, save the filtered data to a new CSV file (or to a shapefile if you want to preserve the geometry)
...
# Step 9: Calculate Airbnb density (number of Airbnb listings per LSOA area)
...
# Step 10: Calculate Airbnb density per square kilometer
...
# Step 11: Merge the average price data back with LSOA data
lsoa_data = lsoa_data.merge(average_price, on='LSOA11CD', how='left')

# Step 12: Optionally, save the results to a new CSV or Shapefile
lsoa_data[['LSOA11CD', 'average_price', 'airbnb_density']].to_csv('data/LSOA_airbnb_summary.csv', index=False)

# Step 13: Print the first few rows to check the result
...
# Step 1: Merge the datasets based on the correct columns
...
# Step 3: Check the first few rows of the final data
print(final_data.head())

# Step 4: Optionally, save the final merged data to a CSV file
