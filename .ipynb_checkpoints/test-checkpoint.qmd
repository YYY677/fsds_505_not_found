...
## Exploring the Impact Profile of on London Communities
Research objectives: To assess the impact of Airbnb across different regions by geodemographic categorisation of different London neighbourhoods and to provide scientific evidence for policy makers to understand which neighbourhoods are affected by Airbnb short-term rentals (STL) and which are likely to face this impact in the future. Differentiated policy recommendations will be proposed to avoid one-size-fits-all regulation.
