...
df = pd.read_csv(f'{host}/{path}/{file}', compression='gzip', low_memory= False)
df.info()
```
...
ax.set_title('London Airbnb Listings Price Per Night', 
             fontdict={'fontsize':'20', 'fontweight':'3'})  #provide a title , 'family':fontname}
...
```{python}
# Spatial join
merged_data = gpd.sjoin(gdf1, LB, how="inner", predicate="intersects")
