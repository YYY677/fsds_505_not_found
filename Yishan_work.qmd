...
###  Standardization (Z-score scaling) 
 - To scale data to have a mean of 0 and a standard deviation of 1.
...
# Choose optimal K based on the plots (e.g., 3)
optimal_k = 3
...
cluster_means = final_data.groupby('Cluster')[numeric_columns].mean()
print("Cluster Means:")
print(cluster_means)
