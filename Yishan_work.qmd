...
# Define soft pastel cluster colors (replacing purple with blue)
cluster_colors = {
    0: '#A7C7E7',  # Soft Blue
    1: '#F4A300',  # Soft Peach
    2: '#F1C6C2'   # Soft Rose
...
ax.set_title("K-Means Clustering Results By LSOA", fontsize=16, color="#333333", fontweight='bold')
ax.axis("off")
plt.legend(loc='lower left', fontsize=12, frameon=True, title="Clusters", title_fontsize=14)
